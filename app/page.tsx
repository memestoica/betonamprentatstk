      ...
      <section className="page-shell py-10 sm:py-14">
        <div className="overflow-hidden rounded-[2rem] border border-copper/20 bg-gradient-to-br from-copper/14 via-card to-card p-6 shadow-soft sm:p-8 lg:p-10">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 font-display text-3xl font-semibold tracking-normal text-foreground sm:text-4xl">
              Ce influențează prețul betonului amprentat?
            </h2>
            <p className="mt-4 text-sm leading-7 text-muted sm:text-base">
              Prețul unei lucrări de beton amprentat poate varia în funcție de
              suprafață, pregătirea terenului, grosimea betonului, model, culoare,
              accesul la lucrare și localitate. Pentru o estimare corectă,
              trimite-ne pe WhatsApp localitatea, suprafața aproximativă și câteva
              poze cu zona lucrării.
            </p>
          </div>
